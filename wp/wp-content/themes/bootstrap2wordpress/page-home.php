        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <p>If you&rsquo;re a designer, learning to code your own WordPress websites can change your business
                    ...
                    you in a position to <strong>make an extra $1,000 - $5,000 per project.</strong></p>
                ...
                <p>It&rsquo;s fun to learn challenging new skills. Code hobbyists can add dynamic websites to their
                    arsenal of tools to play with &mdash; you can even <strong>sell WordPress themes and plugins for
                        cash!</strong> The possibilities are truly endless.</p>
...
<section id="project-features">
    <div class="container">
        ...
        <p class="lead">Throughout this entire course, you work towards building an incredibly beautiful website. Want
            to see the website <strong>you</strong> are going to build? <em>You're looking at it!</em> The website
            you're using right now is the website you will have built entirely by yourself, by the end of this course.
        </p>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <img src="<?php bloginfo( 'template_directory'); ?>/assets/img/icon-cms.png" alt="CMS">
